...
RMS is a community project and welcomes any kind of contribution from anyone!

We have development documentation for new contributors, which can be found at <https://docs.rms.dev>.
...
If you have any ideas on how to improve RMS itself, or want to propose a new plugin API, feel free to open a feature request so we can discuss.

Or if you notice any bugs or typos, feel free to fix them!

## Contribute to our Documentation

The source code of our documentation is available at <https://github.com/RMS/Docs>
...
We have an open support channel in our [Discord community](https://rms.dev/discord).
