...
const CONTRIBUTOR_BADGE = "https://raw.githubusercontent.com/zxkuhl/RMSTop/refs/heads/main/icons/logo.svg";

const ContributorBadge: ProfileBadge = {
    id: "rms_contributor_badge",
    description: "RMS Contributor",
...
async function loadBadges(noCache = false) {
    ...
    DonorBadges = await fetch("https://badges.rms.dev/badges.json", init)
        .then(r => r.json());
}
            ...
            onClick() {
                const modalKey = openModal(props => (
                    <ErrorBoundary noop onError={() => {
                        closeModal(modalKey);
                        RMSNative.native.openExternal("https://github.com/sponsors/zxkuhl");
                    }}>
                        <ModalRoot {...props}>
                            <ModalHeader>
                                <Forms.FormTitle
                            ...
                            <ModalContent>
                                ...
                                <div style={{ padding: "1em" }}>
                                    <Forms.FormText>
                                        This Badge is a special perk for RMS Donors
                                    </Forms.FormText>
                                    <Forms.FormText className={Margins.top20}>
                                        Please consider supporting the development of RMS by becoming a donor. It would mean a lot!!
                                    </Forms.FormText>
                                </div>
                            </ModalContent>
                            <ModalFooter>
