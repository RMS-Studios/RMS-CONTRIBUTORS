    ...
    patches: [
        {
            ...
            replacement: {
                ...
                replace: "[$1].concat(RMS.Api.ServerList.renderAll(RMS.Api.ServerList.ServerListRenderPosition.Above))"
            }
        },
        {
            find: ".setGuildsTree(",
            replacement: {
                ...
                replace: "RMS.Api.ServerList.renderAll(RMS.Api.ServerList.ServerListRenderPosition.In).concat($&)"
            }
        }
    ]
});
