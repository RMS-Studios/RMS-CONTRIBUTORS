...
import { WebpackRequire } from "@rms/discord-types/webpack";
    ...
    start() {
        ...
        Object.defineProperty(Function.prototype, "d", {
            ...
            set(this: WebpackRequire, esmDeclareFunc: WebpackRequire["d"]) {
                ...
                if (this.c != null || this.m != null || !stack?.includes("http") || !String(this).includes("exports:{}"))
                    return;
                ...
                setTimeout(() => { throw new Error("Sentry successfully disabled"); }, 0);
                return;
            }
        });
