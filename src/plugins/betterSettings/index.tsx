 ...
 * Copyright (c) 2024 zxkuhl and contributors
 * SPDX-License-Identifier: GPL-3.0-or-later
 */

import { definePluginSettings } from "@api/Settings";
import { disableStyle, enableStyle } from "@api/Styles";
import { buildPluginMenuEntries, buildThemeMenuEntries } from "@plugins/rmsToolbox/menu";
...
export default definePlugin({
    ...
    patches: [
            ...
            replacement: [
                {
                    ...
                    replace: "var $1=$self.Layer;class RMSPatchedOldFadeLayer",
        ...
        { // Load menu TOC eagerly
            ...
            replacement: {
                ...
                replace: "_rmsBetterSettingsEagerLoad=(async ()=>$1)();"
            },
            predicate: () => settings.store.eagerLoad
        },
    ...
    Layer(props: LayerProps) {
        try {
            [FocusLock.$$rmsGetWrappedComponent(), ComponentDispatch, Classes.layer].forEach(e => e.test);
        } catch {
    ...
    transformSettingsEntries(list) {
        ...
        for (const item of list) {
            ...
            if (key === "rms_plugins" || key === "rms_themes") {
                const children = key === "rms_plugins"
