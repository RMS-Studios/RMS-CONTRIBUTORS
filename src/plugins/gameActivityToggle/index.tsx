...
import RMSToolboxPlugin from "@plugins/rmsToolbox";
...
const settings = definePluginSettings({
    ...
    location: {
        ...
        options: [
            ...
            { label: "RMS Toolbox", value: "TOOLBOX" }
        ],
        get hidden() {
            return !isPluginEnabled(RMSToolboxPlugin.name);
        }
    }
});
...
function GameActivityToggleButton(props: { nameplate?: any; }) {
    ...
    if (location !== "PANEL" && isPluginEnabled(RMSToolboxPlugin.name)) return null;
